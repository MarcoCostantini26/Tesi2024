...
<div id="app" class="container mt-5">
    ...
    <div class="image-container">
        <div v-for="image in images" :key="image.fi_ID" class="image-box">
            <img :src="'finalImages/' + image.fi_nome" alt="Immagine">
            <div class="button-container">
                <button class="delete-button" @click="deleteImage(image.fi_ID, image.fi_nome)">Elimina</button>
                <button class="btn btn-primary save-button" @click="saveImage(image.fi_nome)">Salva</button>
            </div>
        </div>
    </div>
</div>
        ...
        methods: {
            ...
            deleteImage(imageId, imageName) {
                if (confirm("Sei sicuro di voler eliminare questa immagine?")) {
                    axios.post('delete_final_image.php', {
