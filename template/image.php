...
$sql_segmented_images = "SELECT si_ID, si_ID_ImmagineOriginale, si_nome FROM si_segmented_images";
        ...
        <div class="col-md-6 p-5">
            ...
            if ($result_segmented_images->num_rows > 0) {
                ...
                while ($row = $result_segmented_images->fetch_assoc()) {
                    echo "<option value='" . $row['si_nome'] . "' data-original-id='" . $row['si_ID_ImmagineOriginale'] . "'>" . $row['si_nome'] . "</option>";
                }
                echo "</select>";
            } else {
